...
| status                            | ~~in uitvoering~~; ~~in gebruik~~[^4]; ~~buiten gebruik~~ |

[^4]: status ‘in uitvoering’ en ‘in gebruik’ worden samengevoegd tot status
‘bestaand’.
