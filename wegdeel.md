...
Onderstaande classificaties worden toegevoegd aan BRT.Next

| BRT.Next:attribuutnaam | Domeinwaarde          | Definitie                                                                                                                                                                                      |
|------------------------|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| type                   | **OV-baan**           | Wegdeel dat uitsluitend is bestemd en gemarkeerd voor openbaar vervoer en afgescheiden is van de andere wegdelen niet uitsluitend door markering.                                              |
...
|                        | **fietsveer**         | BRT: Vastgelegde route over water om voertuigen en personen over te zetten al dan niet op basis van                                                                                            |
...
Van onderstaande classificaties in TOP10NL wijzigt de naam (waarde) en definitie
in BRT.Next.
...
De volgende attributen en bijbehorende classificaties komen te vervallen:

| TOP10NL:attribuutnaam     | TOP10NL:classificaties,domein                                                                         |
|---------------------------|-------------------------------------------------------------------------------------------------------|
...
De volgende classificaties komen te vervallen. Het attribuut blijft wel bestaan.

| Naam attribuut TOP10NL / BRT.Next | Domein, classificaties TOP10NL            |
|-----------------------------------|-------------------------------------------|
